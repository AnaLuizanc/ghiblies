...
const AboutSection: React.FC = () => {
  // Observadores para animações baseadas em visibilidade
  ...
  // Valores da organização com seus ícones e descrições
  const values = [
    {
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="mb-16" ref={textRef}>
          <div className="flex flex-col md:flex-row items-center">
            ...
            {/* Imagem ilustrativa do NDTI com efeitos visuais */}
            <div className={cn(
              ...
              <div className="relative">
                ...
                <div className="relative bg-gray-800 p-2 sm:p-4 rounded-lg shadow-lg">
                  <img 
        ...
        {/* Seção de valores com cards animados */}
        <div ref={valuesRef}>
          <h3 className="text-2xl font-semibold text-center mb-8 sm:mb-12 text-ndti-300">Nossos Valores</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {values.map((value, index) => (
              <div 
                key={index} 
                className={cn(
                  "bg-gray-800 p-6 rounded-lg shadow-md text-center card-hover transform transition-all duration-500",
              ...
              >
                ...
                <h4 className="text-xl font-semibold mb-2 text-ndti-300">{value.title}</h4>
