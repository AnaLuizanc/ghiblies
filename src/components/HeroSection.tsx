...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="relative pt-20 sm:pt-24 md:pt-32 lg:pt-40 pb-40 md:pb-56 overflow-hidden bg-gradient-to-br from-ndti-950 via-ndti-900 to-ndti-800">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-1/2 mb-10 md:mb-0 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              {/* Botão de serviços com efeito de hover */}
              <a 
                href="#servicos" 
          ...
          <div className="w-full md:w-1/2 flex justify-center animate-fade-in-right">
            {/* Imagem principal com efeitos de hover */}
      ...
      {/* Onda na parte inferior - posicionada mais abaixo */}
      <div className="absolute bottom-0 left-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full">
          <path fill="#1f2937" fillOpacity="1" d="M0,288L48,272C96,256,192,224,288,213.3C384,203,480,213,576,229.3C672,245,768,267,864,261.3C960,256,1056,224,1152,208C1248,192,1344,192,1392,192L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
        {/* Removido o estilo dinâmico já que agora o tema é sempre escuro */}
      </div>
    </section>
  );
};
