...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="relative pt-20 sm:pt-24 md:pt-32 lg:pt-40 pb-24 md:pb-40 lg:pb-48 overflow-hidden bg-gradient-to-br from-ndti-950 via-ndti-900 to-ndti-800">
      {/* Decorative elements */}
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-1/2 mb-10 md:mb-0 animate-fade-in">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-white leading-tight">
              Núcleo de <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-ndti-400">Desenvolvimento</span> Tecnológico e Inovação
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                href="#servicos" 
                className="px-5 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-yellow-400 to-ndti-500 hover:from-yellow-500 hover:to-ndti-600 text-white rounded-md hover:shadow-lg hover:shadow-ndti-700/30 transition-all duration-300 flex items-center group"
              >
                Nossos Serviços
          ...
          <div className="w-full md:w-1/2 flex justify-center animate-fade-in-right">
            <div className="relative w-full max-w-md transform transition-all duration-500 hover:scale-105 hover:-rotate-1">
              <div className="absolute -inset-1 rounded-lg bg-gradient-to-r from-yellow-400 via-ndti-500 to-ndti-700 opacity-75 blur-lg animate-[pulse_4s_ease-in-out_infinite]"></div>
              <div className="relative bg-ndti-900/50 backdrop-blur-sm p-2 sm:p-4 rounded-lg shadow-2xl border border-white/10">
                ...
                <div className="absolute -bottom-4 -right-4 bg-ndti-800/90 backdrop-blur-sm p-2 sm:p-3 rounded-full shadow-lg border border-white/10 transition-transform hover:scale-110 hover:rotate-12 cursor-pointer group">
                  <Globe className="w-6 h-6 sm:w-8 sm:h-8 text-white group-hover:text-yellow-300 transition-colors" />
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Bottom wave with extended green area */}
